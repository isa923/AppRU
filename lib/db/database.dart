...
class Database {
  static List Comidas = [
    Novascomidas(
      titulo: 'TAPIOCA',
      descricao: 'Prove da melhor tapioca da região',
      urlImagem:
    ...
    Novascomidas(
      ...
      descricao: 'Prove do melhor pão de queijo da região',
      urlImagem:
    ...
    Novascomidas(
      ...
      descricao: 'Prove do melhor cuscuz recheado da região',
      urlImagem:
    ...
    Novascomidas(
      titulo: 'BOLO COMUM',
      descricao: 'Prove do melhor bolo da região',
      urlImagem:
